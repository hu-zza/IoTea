...
public abstract class Problem extends AbstractThrowableProblem implements Response {
  ...
  protected Problem(
      String deviceId, String commandId, URI type, String title, StatusType status, String detail) {
  ...
  protected Problem(
      String deviceId, String commandId, String type, String title, int statusCode, String detail) {
